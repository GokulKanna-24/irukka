  ...
  <div class="container">
    <div class="row flex-center">
      <div class="col-xxl-9 py-7 text-center">
        <h1 class="fw-bold mb-4 text-white fs-6">Skip the Guess, Know the rest<br />Shop status in a snap! </h1>
        <a href="https://wa.me/9025113043?text=Hello%20there!%20I%20need%20some%20assistance."
          class="btn btn-success"
          target="_blank">
          <i class="fab fa-whatsapp"></i> Contact Us
        </a>
        {{-- <a class="btn btn-danger" href="#"> Contact Us<i class="fas fa-chevron-right ms-2"></i></a> --}}
      </div>
    </div>
  </div>
</section>
